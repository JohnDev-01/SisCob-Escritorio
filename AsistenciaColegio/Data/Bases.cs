...
namespace SisCob.Data
{
    public class Bases
    {
        ...
        public static bool enviarCorreo(string emisor, string password, string mensaje, string asunto, string destinatario, string ruta)
        {
            ...
            {
                MessageBox.Show("Error de red!", "Restauracion de contraseña: ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        ...
        public static string Encriptar(string texto)
        {
            try
            {
                ...
                keyArray = hashmd5.ComputeHash(UTF8Encoding.UTF8.GetBytes("proyectoempresarial"));
